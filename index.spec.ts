...
describe('unit test using ` mocha ☕️ ` & ` chai 🍵 ` is running 👻 ..', () => {
  ...
  __MongoDB_ObjectID__CATCH__: MongoDB_ObjectId, 
  ...
  beforeEach(() =>{
   ...
   __MongoDB_ObjectID__CATCH__ = { "$oid" : "507f191e810c19*29de860ea" }
  ...
  it('catch case ⛔️ .. ', () => {
     ...
     expect(() => shortObjectId(__MongoDB_ObjectID__CATCH__)).to.throw(new Error('Please check your MongoDB ObjectId : the value of `$oid` should be have only lowercase character and number `<a..z> & <0..9>` ..').message);
